...
for($i = 1; $i < 5; $i++) {
	...
	switch($i){
	case 1:
	$ekipAdi="YANGINLA MUCADELE EKIBI";
echo'
<div class="polaroid" id="NW" style= "background-image: url(arka12.jpg); background-repeat:no-repeat; background-size: cover;">
<p align="center" style=" padding:40px;  font-family:Monospace; color: #ffffff; font-size:3vw;" >'.$ekipAdi.'</p> 
 <div>
