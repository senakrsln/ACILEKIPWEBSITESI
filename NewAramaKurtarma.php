...
<div class="section_container third_section_container flex_container flex_center">		';
	...
	<br>
	               ...
	               <div class="google_map">
					<img src="./'.$imgs.'" height="100vw" weight="100vw" style=" box-shadow: 0 4px 6px 0 rgba(0, 0, 0, 3), 0 2px 4px 0 rgba(0, 0, 0, 3); border: 2px solid #fff;  margin-left: auto; margin-right: auto; display: block;"></img>
						...
						<div class="paragraph">
					 <br><div  align="center" style=" box-shadow: 0 4px 6px 0 rgba(0, 0, 0, 3), 0 2px 4px 0 rgba(0, 0, 0, 3); background-color: #ffffff; height: 50%; width: 100%; margin-bottom:1vw; "><p style=" margin-top:-15px; margin-bottom:10px; padding-left:5px; padding-right:60px; color: #4B4848; font-size:90%;" > '.$bolgeAdı.'</p></div>
	...
	<p style="font-size:60%">Görev Durumu</p>
	';
